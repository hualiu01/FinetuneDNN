...
# load the model
net = caffe.Net('./vgg16/deploy.prototxt', 1, weights='./vgg16/VGG_ILSVRC_16_layers.caffemodel')
# net = caffe.Net('./vgg16_ft/deploy.prototxt', 1, weights='./vgg16_ft/vgg2.caffemodel')
...
fs = open('../lfw_funneled/pairs_03.txt','r')
lines = fs.readlines()
N = 0
imgs = list()
for line in lines:
